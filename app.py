...
selected_atom_df["node-type"].value_counts().to_frame().reset_index().rename(columns = {'index':'node_type', 'node-type':'count'}, inplace = True)
st.write(type(selected_atom_df))
